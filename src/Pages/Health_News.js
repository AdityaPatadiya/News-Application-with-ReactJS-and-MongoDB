...
function Health() {
    ...
    useEffect(() => {
        const fetchData = () => {
            fetch("https://newsapi.org/v2/top-headlines?category=health&pagesize=50&language=en&apiKey=8e483ece11494f4da3d1889194bc4790")
                .then(res => res.json())
                .then(data => {
                    if (data.status === "ok") {
    ...
    return (
        <div className="container"><br />
            ...
            <br />
            <h1 className="text-center">"Healthy News"</h1>
            <br />
            <div className="row">
