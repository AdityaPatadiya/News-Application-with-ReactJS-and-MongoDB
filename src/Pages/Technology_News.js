...
function Tech() {
    ...
    useEffect(() => {
        const fetchData = () => {
            fetch("https://newsapi.org/v2/top-headlines?category=technology&pagesize=50&language=en&apiKey=8e483ece11494f4da3d1889194bc4790")
                .then(res => res.json())
                .then(data => {
                    if (data.status === "ok") {
    ...
    return (
        ...
        <div className="container">
            <br />
            <h1 className="text-center">"Tech New(s)"</h1>
            <br />
            <div className="row">
